...
class Architect(object):
    def __init__(self, model):
        ...
        self.model.train()
        #if '_1' in name
        self.optimizer1 = torch.optim.Adam([{'params':[ param for name, param in model.named_parameters() if '_1' in name]}],
    ...
    def step(self, input_valid, target_valid,device,score,length,optim):
        ...
        if optim==1:
            ...
            #for name, parms in self.model.named_parameters():	
                #print(name)
            loss,loss1,loss2=self._backward_step1(input_valid.to(device), target_valid.to(device),score,device,length)
