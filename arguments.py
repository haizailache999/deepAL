...
def get_args():
	...
	#basic arguments
	parser.add_argument('--ALstrategy', '-a', default='LeastConfidence', type=str, help='name of active learning strategies')
	parser.add_argument('--quota', '-q', default=int(50000*0.30), type=int, help='quota of active learning')
	parser.add_argument('--batch', '-b', default=int(50000*0.02), type=int, help='batch size in one active learning iteration')
	...
	parser.add_argument('--initseed', '-s', default = int(50000*0.025)*4, type = int, help = 'Initial pool of labeled data')
	parser.add_argument('--gpu', '-g', default = 3, type = str, help = 'which gpu')
